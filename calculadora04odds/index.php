...
<head>
    ...
    <title>Calculadora Arbitragem 04 ODDS</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div class="container">
        <h1>Calculadora Arbitragem 04 ODDS</h1>
        <form id="surebetForm">
            <!-- Campo para Odd 1 -->
            ...
            <!-- Novo Campo para Odd 4 -->
            <div class="input-group">
                <label for="odd4">Odd 4:</label>
                <input type="number" step="0.01" id="odd4" name="odd4" oninput="atualizarCalculo()">
                <span id="retorno4" class="retorno"></span>
            </div>
